...
plt = scatter(train_rsteps, ode_data[1, 1:end]; label = "Ground truth data",color = "blue",title = "Mass with respect to radius",xlabel = "radius",ylabel = "mass")
...
plot!(plt, train_rsteps, data_pred[1, 1:end]; label = "NNODE Training prediction",color = "blue",title = "Mass with respect to radius",xlabel = "radius",ylabel = "mass")
# plot!(plt, test_rsteps, data_pred[1, train_datasize + 1:end]; label = "NNODE Forecast prediction",color = "red",title = "Mass with respect to radius",xlabel = "radius",ylabel = "mass")
...
plt = scatter(rsteps, ode_data[1, 1:end]; label = "Ground truth data",color = "red",title = "Mass with respect to radius",xlabel = "radius",ylabel = "mass")
# scatter!(test_rsteps, ode_data[1, train_datasize + 1:end]; label = "Ground truth data",color = "red",title = "Mass with respect to radius",xlabel = "radius",ylabel = "mass")
# scatter!(plt, train_rsteps, pred[:,1:train_datasize]; label = "train data")
plot!(plt, rsteps, data_pred[1, 1:end]; label = "NNODE Training prediction",color = "blue",title = "Mass with respect to radius",xlabel = "radius",ylabel = "mass")
# plot!(plt, test_rsteps, data_pred[1, train_datasize + 1:end]; label = "NNODE Forecast prediction",color = "red",title = "Mass with respect to radius",xlabel = "radius",ylabel = "mass")
